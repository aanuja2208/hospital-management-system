# Healthcare Operations & Decision Analytics System

A comprehensive hospital operations and decision support system designed to manage clinical workflows and leverage data analytics for optimizing hospital efficiency. Built with FastAPI, SQLite (SQLAlchemy), and an advanced analytical data model, this system extends beyond standard CRUD capabilities to provide predictive modeling and operational recommendations.

## Analytics & Decision Support Highlights

- **Operational Data Model**: Features a properly designed star schema (FactAppointments, DimPatient, DimDoctor, DimDepartment, DimDate) optimized for business intelligence workflows.
- **Advanced SQL Analytics**: Over 20 complex queries (`analytics/analytics.sql`) utilizing CTEs, window functions, and conditional aggregation to evaluate doctor utilization, bottleneck departments, and patient wait times.

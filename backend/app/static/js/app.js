// ============================================
// Hospital Management Platform — SPA
// ============================================
const API = '/api/v1';
...
async function viewEncounter(apptId) {
    // We don't have a direct endpoint by appointment ID, show info
...
async function renderHistory() {
    ...
    // Patient history isn't directly accessible without profile ID from frontend
    document.getElementById('pageContent').innerHTML = `
